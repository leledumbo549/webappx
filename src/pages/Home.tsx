        ...
        <section>
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                shadcn/ui is a collection of beautifully designed components
                built with Radix UI and Tailwind CSS, designed for React
                projects.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                ...
                React code. Each component is customizable with Tailwind
                classes.
              </AccordionContent>
            </AccordionItem>
