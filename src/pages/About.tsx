function About() {
  return (
    <div className="max-w-2xl mx-auto p-4">
      ...
      <p className="mb-4 text-gray-700">
        Founded in 2025, our team started as a small group of friends who loved
        coding and solving real-world problems. Over time, we have grown into a
        collaborative community, always striving to learn and innovate.
      </p>
