import{G as L,H as I,K as $,a3 as u,$ as f,O as U,J as l,V as P,a5 as A,a6 as F,U as d,a2 as E,Y as b,a7 as N,W as p,a8 as W,_ as v,a9 as D,M as O,T as S}from"./index-CrjmnEeE.js";import{n as j,r as c,c as _,o as y}from"./if-defined-Dr4zPP72.js";import{O as R}from"./index-CQCEQNYB.js";import{e as M}from"./index-Bc1g9c_w.js";import"./index-C63O7_qW.js";import"./index-DfXjOv4G.js";import"./index-BJn5W0e4.js";import"./index-2mAFmQBU.js";import"./index-BpUiDJI8.js";import"./index-DWJTKLUb.js";import"./ref-B-Ucs7Fl.js";import"./ConstantsUtil-Dmg8YACJ.js";import"./index-C2S5cRQi.js";import"./index-CV9ldt-_.js";const q=L`
  :host {
...
`;var x=function(n,e,t,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,t,o);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(i=(r<3?s(i):r>3?s(e,t,i):s(e,t))||i);return r>3&&i&&Object.defineProperty(e,t,i),i};let w=class extends I{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=$.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=u.state.remoteFeatures,this.isPwaLoading=!1,this.unsubscribe.push($.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(t=>t.type==="AUTH")}),u.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=this.remoteFeatures?.socials||[];const t=!!this.authConnector,o=e?.length,r=f.state.view==="ConnectSocials";return(!t||!o)&&!r?null:(r&&!o&&(e=U.DEFAULT_SOCIALS),l` <wui-flex flexDirection="column" gap="xs">
      ${e.map(i=>l`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){e&&await M(e)}async handlePwaFrameLoad(){if(P.isPWA()){this.isPwaLoading=!0;try{this.authConnector?.provider instanceof A&&await this.authConnector.provider.init()}catch(e){F.open({shortMessage:"Error loading embedded wallet in PWA",longMessage:e.message},"error")}finally{this.isPwaLoading=!1}}}};w.styles=q;x([j()],w.prototype,"tabIdx",void 0);x([c()],w.prototype,"connectors",void 0);x([c()],w.prototype,"authConnector",void 0);x([c()],w.prototype,"remoteFeatures",void 0);x([c()],w.prototype,"isPwaLoading",void 0);w=x([_("w3m-social-login-list")],w);const z=L`
  wui-flex {
