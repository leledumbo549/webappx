import{G as f,H as w,V as I,Y as x,a2 as H,ab as l,J as u,P as z,a0 as W,$ as g,aa as L,ac as q,_ as B,W as F,X as M,Z as Y}from"./index-DoVSQYSp.js";import{n as d,r as c,c as m,U as b,o as G}from"./if-defined-6kX8uuOc.js";import"./index-C-B0W311.js";import"./index-BpJi_q0o.js";import{e as O,n as D}from"./ref-BL-irNaq.js";import{n as J,s as K}from"./ConstantsUtil-Dmg8YACJ.js";import"./index-CxF6Y7JE.js";import{S as X}from"./index-DC0149bR.js";import"./index-C-fomtHM.js";import"./index-qBZF6oxn.js";import"./index-B2BPeu23.js";import"./index-DyUpIlu1.js";import"./index-BXTZ44Ty.js";const Z=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var j=function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var a=o.length-1;a>=0;a--)(s=o[a])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let C=class extends w{constructor(){super(...arguments),this.inputElementRef=O(),this.disabled=!1,this.value="",this.placeholder="0"}render(){return this.inputElementRef?.value&&this.value&&(this.inputElementRef.value.value=this.value),u`<input
    ...
    /> `}dispatchInputChangeEvent(e){const i=e.data;if(i&&this.inputElementRef?.value)if(i===","){const n=this.inputElementRef.value.value.replace(",",".");this.inputElementRef.value.value=n,this.value=`${this.value}${n}`}else J.test(i)||(this.inputElementRef.value.value=this.value.replace(new RegExp(i.replace(K,"\\$&"),"gu"),""));this.dispatchEvent(new CustomEvent("inputChange",{detail:this.inputElementRef.value?.value,bubbles:!0,composed:!0}))}};C.styles=[z,W,Q];j([d({type:Boolean})],C.prototype,"disabled",void 0);j([d({type:String})],C.prototype,"value",void 0);j([d({type:String})],C.prototype,"placeholder",void 0);C=j([m("wui-input-amount")],C);const ee=f`
  :host {
    width: 100%;
    height: 100px;
    border-radius: var(--wui-border-radius-s);
