import{M as p,ay as T,$ as c,G as v,P as _,H as y,J as l,a6 as I,a0 as ae,at as se,Y as h,ac as D,am as ne,a7 as L,W as V,a3 as W,K as H,U as Y,_ as S,au as E,T as re,aC as ce,an as le,V as de,Q as ue}from"./index-CrjmnEeE.js";import{c as f,n as u,r as d,o as z,U as pe}from"./if-defined-Dr4zPP72.js";import"./index-D-zxq6DA.js";import"./index-CV9ldt-_.js";import"./index-C63O7_qW.js";import"./index-B_-Zf5Vm.js";import"./index-C2S5cRQi.js";import"./index-ViQx7Lg6.js";import"./index-CgmXG9GP.js";const F={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){p.shake();return}if(await T.isSIWXCloseDisabled()){p.shake();return}p.close()}},he=v`
  :host {
    display: block;
...
`;var we=function(n,e,t,i){var a=arguments.length,o=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,e,t,i);else for(var r=n.length-1;r>=0;r--)(s=n[r])&&(o=(a<3?s(o):a>3?s(e,t,o):s(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o};let M=class extends y{render(){return l`<slot></slot>`}};M.styles=[_,he];M=we([f("wui-card")],M);const me=v`
  :host {
    display: flex;
    align-items: center;
...
`;var $=function(n,e,t,i){var a=arguments.length,o=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,e,t,i);else for(var r=n.length-1;r>=0;r--)(s=n[r])&&(o=(a<3?s(o):a>3?s(e,t,o):s(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o};let k=class extends y{constructor(){super(...arguments),this.message="",this.backgroundColor="accent-100",this.iconColor="accent-100",this.icon="info"}render(){return this.style.cssText=`
   ...
   `,l`
    ...
    `}onClose(){I.close()}};k.styles=[_,me];$([u()],k.prototype,"message",void 0);$([u()],k.prototype,"backgroundColor",void 0);$([u()],k.prototype,"iconColor",void 0);$([u()],k.prototype,"icon",void 0);k=$([f("wui-alertbar")],k);const fe=v`
  :host {
    display: block;
    position: absolute;
...
`;var Q=function(n,e,t,i){var a=arguments.length,o=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,e,t,i);else for(var r=n.length-1;r>=0;r--)(s=n[r])&&(o=(a<3?s(o):a>3?s(e,t,o):s(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o};let P=class extends y{constructor(){super(...arguments),this.imageSrc=""}render(){return l`<button>
    ...
    ></wui-icon-box>`}};P.styles=[_,ae,se,ge];Q([u()],P.prototype,"imageSrc",void 0);P=Q([f("wui-select")],P);const ve=v`
  :host {
    height: 64px;
  }
...
`;var x=function(n,e,t,i){var a=arguments.length,o=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,e,t,i);else for(var r=n.length-1;r>=0;r--)(s=n[r])&&(o=(a<3?s(o):a>3?s(e,t,o):s(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o};let m=class extends y{constructor(){super(...arguments),this.backgroundColor="accent-100",this.iconColor="accent-100",this.icon="checkmark",this.message="",this.loading=!1,this.iconType="default"}render(){return l`
    ...
    `}templateIcon(){return this.loading?l`<wui-loading-spinner size="md" color="accent-100"></wui-loading-spinner>`:this.iconType==="default"?l`<wui-icon size="xl" color=${this.iconColor} name=${this.icon}></wui-icon>`:l`<wui-icon-box
      ...
      icon=${this.icon}
      background="opaque"
    ></wui-icon-box>`}};m.styles=[_,Ce];x([u()],m.prototype,"backgroundColor",void 0);x([u()],m.prototype,"iconColor",void 0);x([u()],m.prototype,"icon",void 0);x([u()],m.prototype,"message",void 0);x([u()],m.prototype,"loading",void 0);x([u()],m.prototype,"iconType",void 0);m=x([f("wui-snackbar")],m);const ke=v`
  :host {
    display: block;
    position: absolute;
    opacity: 0;
...
`;var C=function(n,e,t,i){var a=arguments.length,o=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,e,t,i);else for(var r=n.length-1;r>=0;r--)(s=n[r])&&(o=(a<3?s(o):a>3?s(e,t,o):s(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o};const X="scroll-lock";class g extends y{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.hasPrefetched=!1,this.enableEmbedded=W.state.enableEmbedded,this.open=p.state.open,this.caipAddress=h.state.activeCaipAddress,this.caipNetwork=h.state.activeCaipNetwork,this.shake=p.state.shake,this.filterByNamespace=H.state.filterByNamespace,this.initializeTheming(),E.prefetchAnalyticsConfig(),this.unsubscribe.push(p.subscribeKey("open",e=>e?this.onOpen():this.onClose()),p.subscribeKey("shake",e=>this.shake=e),h.subscribeKey("activeCaipNetwork",e=>this.onNewNetwork(e)),h.subscribeKey("activeCaipAddress",e=>this.onNewAddress(e)),W.subscribeKey("enableEmbedded",e=>this.enableEmbedded=e),H.subscribeKey("filterByNamespace",e=>{this.filterByNamespace!==e&&!h.getAccountData(e)?.caipAddress&&(E.fetchRecommendedWallets(),this.filterByNamespace=e)}))}firstUpdated(){if(this.caipAddress){if(this.enableEmbedded){p.close(),this.prefetch();return}this.onNewAddress(this.caipAddress)}this.open&&this.onOpen(),this.enableEmbedded&&this.prefetch()}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.onRemoveKeyboardListener()}render(){return this.style.cssText=`
    ...
    `,document.head.appendChild(e)}onScrollUnlock(){const e=document.head.querySelector(`style[data-w3m="${X}"]`);e&&e.remove()}onAddKeyboardListener(){this.abortController=new AbortController;const e=this.shadowRoot?.querySelector("wui-card");e?.focus(),window.addEventListener("keydown",t=>{if(t.key==="Escape")this.handleClose();else if(t.key==="Tab"){const{tagName:i}=t.target;i&&!i.includes("W3M-")&&!i.includes("WUI-")&&e?.focus()}},this.abortController)}onRemoveKeyboardListener(){this.abortController?.abort(),this.abortController=void 0}async onNewAddress(e){const t=h.state.isSwitchingNamespace,i=c.state.view==="ProfileWallets";e?await this.onConnected({caipAddress:e,isSwitchingNamespace:t,isInProfileView:i}):!t&&!this.enableEmbedded&&!i&&p.close(),await T.initializeIfEnabled(),this.caipAddress=e,h.setIsSwitchingNamespace(!1)}async onConnected(e){if(e.isInProfileView)return;const{chainNamespace:t,chainId:i,address:a}=le.parseCaipAddress(e.caipAddress),o=`${t}:${i}`,s=!de.getPlainAddress(this.caipAddress),r=await T.getSessions({address:a,caipNetworkId:o}),A=T.getSIWX()?r.some(j=>j.data.accountAddress===a):!0,B=e.isSwitchingNamespace&&A&&!this.enableEmbedded,U=this.enableEmbedded&&s;B?c.goBack():U&&p.close()}onNewNetwork(e){const t=this.caipNetwork,i=t?.caipNetworkId?.toString(),a=t?.chainNamespace,o=e?.caipNetworkId?.toString(),s=e?.chainNamespace,r=i!==o,B=r&&!(a!==s),U=t?.name===ue.UNSUPPORTED_NETWORK_NAME,j=c.state.view==="ConnectingExternal",ee=c.state.view==="ProfileWallets",te=!h.getAccountData(e?.chainNamespace)?.caipAddress,oe=c.state.view==="UnsupportedChain",ie=p.state.open;let N=!1;this.enableEmbedded&&c.state.view==="SwitchNetwork"&&(N=!0),ie&&!j&&!ee&&(te?r&&(N=!0):(oe||B&&!U)&&(N=!0)),N&&c.state.view!=="SIWXSignMessage"&&c.goBack(),this.caipNetwork=e}prefetch(){this.hasPrefetched||(E.prefetch(),E.fetchWalletsByPage({page:1}),this.hasPrefetched=!0)}}g.styles=Se;C([u({type:Boolean})],g.prototype,"enableEmbedded",void 0);C([d()],g.prototype,"open",void 0);C([d()],g.prototype,"caipAddress",void 0);C([d()],g.prototype,"caipNetwork",void 0);C([d()],g.prototype,"shake",void 0);C([d()],g.prototype,"filterByNamespace",void 0);let G=class extends g{};G=C([f("w3m-modal")],G);let q=class extends g{};q=C([f("appkit-modal")],q);export{q as AppKitModal,G as W3mModal,g as W3mModalBase};
